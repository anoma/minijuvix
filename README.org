...
In the following example a MiniJuvix file is compiled using the C backend.  The result is compiled to WASM using [[https://emscripten.org][Clang / LLVM]] and then executed using [[https://wasmer.io][wasmer]].
